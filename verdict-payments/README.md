...
- [Integrate with your signer](../docs/intents/payments.md#java-integration): normal `PolicyEvaluator` and `Intent` APIs.
- Copy an authority: [AP2](../docs/authority/examples/ap2-payment.yaml) or [VI](../docs/authority/examples/mcintent-payment.yaml).
